...
- [azurerm_shared_image_gallery.name](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/shared_image_gallery) (resource)
...
### <a name="input_community_gallery"></a> [community\_gallery](#input\_community\_gallery)
